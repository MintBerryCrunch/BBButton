#
#  Be sure to run `pod spec lint BBButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of BBButton in Markdown format.
  ...
  s.homepage     = "http://EXAMPLE/BBButton"
  ...
  s.source       = { :git => "http://EXAMPLE/BBButton.git", :tag => "0.0.1" }
